...
export default function SignIn(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Aquí puedes manejar el error de inicio de sesión, como mostrar un mensaje de error
    }
  };
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Typography sx={{ textAlign: 'center' }}>
              ...
              <Link
                ...
                variant="body2"
                sx={{ alignSelf: 'center' }}
                onClick={() => setShowSignUp(true)} // Cambiar el estado para mostrar el componente SignUp
              >
                Sign up
              </Link>
            </Typography>
